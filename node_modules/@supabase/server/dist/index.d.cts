 ...
 * ```
 */
declare function withSupabase<Database = unknown, Base extends BaseContext = BaseContext>(config: WithSupabaseConfig, handler: (req: Request, ctx: NoInfer<Base> & SupabaseContext<Database>) => Promise<Response>): (req: Request, ctx?: Base) => Promise<Response>;
/**
 ...
 * ```
 */
declare function withSupabase<Database = unknown>(config: WithSupabaseConfig): Entry<SupabaseContext<Database>>;
//#endregion
