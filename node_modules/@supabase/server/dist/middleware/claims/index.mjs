import { c as Errors, d as InvalidJwtError, f as JwksFetchFailedError, p as JwksNotConfiguredError } from "../../errors-D6WpGqwb.mjs";
...
const withClaims = defineMiddleware({
	...
	run: (config) => async (req) => {
		...
		if (!jwks) return errorResponse(Errors[JwksNotConfiguredError]({ middleware: "withClaims" }));
