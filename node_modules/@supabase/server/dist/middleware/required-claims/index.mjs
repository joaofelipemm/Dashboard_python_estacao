import { E as UnusableCredentialError, c as Errors, d as InvalidJwtError, f as JwksFetchFailedError, g as MissingCredentialsError, p as JwksNotConfiguredError } from "../../errors-D6WpGqwb.mjs";
...
import { n as resolveJwks } from "../../resolve-env-AHEXnbNq.mjs";
...
const withRequiredClaims = defineMiddleware({
	...
	run: (config) => async (req) => {
		...
		if (!jwks) return errorResponse(Errors[JwksNotConfiguredError]({ middleware: "withRequiredClaims" }));
