...
const require_resolve_env = require("../../resolve-env-CGEcHK6B.cjs");
...
const withRequiredClaims = (0, require("@supabase/middleware").defineMiddleware)({
	...
	run: (config) => async (req) => {
		...
		if (!jwks) return require_error_response.errorResponse(require_errors.Errors[require_errors.JwksNotConfiguredError]({ middleware: "withRequiredClaims" }));
