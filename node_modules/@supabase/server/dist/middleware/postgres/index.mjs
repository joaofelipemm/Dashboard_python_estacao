import { T as UnsupportedRoleError, c as Errors } from "../../errors-D6WpGqwb.mjs";
import { t as errorResponse } from "../../error-response-C36qiuma.mjs";
import { a as resolveConnectionString, i as missingConnectionStringResponse, n as ident, r as getPool, t as compileTemplate } from "../../sql-BjKcU4sx.mjs";
...
const withPostgresClient = defineMiddleware({
	...
	run: (config) => async (_req, ctx) => {
		...
		if (!connectionString) return missingConnectionStringResponse("withPostgresClient");
