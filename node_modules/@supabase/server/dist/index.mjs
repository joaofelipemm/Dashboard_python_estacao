import { a as preAuthName, i as fromSupabaseUrl, n as resourceMetadataResponse, r as unauthorizedResponse, t as withOAuthProtectedResource } from "./with-oauth-protected-resource-CjgsBZER.mjs";
import { C as NoKeysConfiguredError, E as UnusableCredentialError, S as MissingSupabaseURLError, T as UnsupportedRoleError, _ as MissingDefaultPublishableKeyError, a as EnvGenericError, b as MissingResourceServerError, c as Errors, d as InvalidJwtError, f as JwksFetchFailedError, g as MissingCredentialsError, h as MissingConnectionStringError, i as EnvError, l as InvalidApiKeyError, m as MissingAuthorizationServerError, n as AuthGenericError, o as ErrorCodeHeader, p as JwksNotConfiguredError, r as CreateSupabaseClientError, s as ErrorSource, t as AuthError, u as InvalidCredentialsError, v as MissingDefaultSecretKeyError, w as SupabaseServerError, x as MissingSecretKeyError, y as MissingPublishableKeyError } from "./errors-D6WpGqwb.mjs";
import { t as errorResponse } from "./error-response-C36qiuma.mjs";
import { n as constructionFailureResponse, r as isConstructionFailure, t as withSupabaseClient } from "./client-C2eIyO47.mjs";
import { t as verifyAuth } from "./verify-auth-BTsXrndi.mjs";
import { t as withSupabaseAdminClient } from "./admin-client-lSn9lkg-.mjs";
import { t as createSupabaseContext } from "./create-supabase-context-x4sBmD37.mjs";
...
const withConstructionBoundary = defineMiddleware({
	...
	run: (config) => async function* () {
		try {
			...
			if (isConstructionFailure(error)) return constructionFailureResponse(error, config.errors);
			throw error;
		}
	}
});
