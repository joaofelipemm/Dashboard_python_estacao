import { c as Errors, i as EnvError, r as CreateSupabaseClientError, t as AuthError } from "./errors-D6WpGqwb.mjs";
...
import { t as createContextClient } from "./create-context-client-CI0CSH3c.mjs";
...
*/
function markConstructionFailure(error) {
...
function isConstructionFailure(error) {
	return (error instanceof EnvError || error instanceof AuthError) && constructionFailure in error;
}
/**
...
const base = defineMiddleware({
	...
	run: (config) => async (req, ctx) => {
		...
		try {
			...
			throw markConstructionFailure(e instanceof EnvError ? e : Errors[CreateSupabaseClientError]({ cause: e }));
		}
		return { supabase };
	}
});
...
//#endregion
export { constructionFailureResponse as n, isConstructionFailure as r, withSupabaseClient as t };
